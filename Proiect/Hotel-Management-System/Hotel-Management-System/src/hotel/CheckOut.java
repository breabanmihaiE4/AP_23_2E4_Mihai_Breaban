...
public class CheckOut extends JFrame {
    ...
    public CheckOut() throws SQLException {
        ...
        labelCheckOut.setFont(new Font("Tahoma", Font.PLAIN, 20));
        labelCheckOut.setBounds(70, 11, 140, 35);
        contentPane.add(labelCheckOut);

        JLabel labelNumber = new JLabel("Number :");
        labelNumber.setBounds(20, 85, 80, 14);
        ...
        l2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    ResultSet rs = c.statemant.executeQuery("select * from customer where number = " + number);
        ...
        labelRoomNumber.setBounds(20, 132, 86, 20);
        ...
        btnCheckOut.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    c.statemant.executeUpdate(deleteSQL);
